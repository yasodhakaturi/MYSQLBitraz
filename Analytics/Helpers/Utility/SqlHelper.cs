...
{
    //public static int UpdateQuery(string connectionString, CommandType commandType, string commandText)
    //{
...
//    /// <returns>MySqlDataAdapter  containing the results of the command</returns>
//    //private static MySqlDataAdapter  ExecuteReader(MySqlConnection connection, MySqlTransaction transaction, CommandType commandType, string commandText, MySqlParameter[] commandParameters, MySqlConnectionOwnership connectionOwnership)
//    //{
//    //    if (connection == null) throw new ArgumentNullException("connection");
...
//    /// <remarks>
//    /// e.g.:  
//    ///  MySqlDataAdapter  dr = ExecuteReader(connString, CommandType.StoredProcedure, "GetOrders");
//    /// </remarks>
//    /// <param name="connectionString">A valid connection string for a MySqlConnection</param>
//    /// <param name="commandType">The CommandType (stored procedure, text, etc.)</param>
//    /// <param name="commandText">The stored procedure name or T-SQL command</param>
//    /// <returns>A MySqlDataAdapter  containing the resultset generated by the command</returns>
//    public static MySqlDataAdapter  ExecuteReader(string connectionString, CommandType commandType, string commandText)
//    {
//        // Pass through the call providing null for the set of SqlParameters
...
//    /// <remarks>
//    /// e.g.:  
//    ///  MySqlDataAdapter  dr = ExecuteReader(connString, CommandType.StoredProcedure, "GetOrders", new MySqlParameter("@prodid", 24));
//    /// </remarks>
//    /// <param name="connectionString">A valid connection string for a MySqlConnection</param>
//    /// <param name="commandType">The CommandType (stored procedure, text, etc.)</param>
//    /// <param name="commandText">The stored procedure name or T-SQL command</param>
//    /// <param name="commandParameters">An array of SqlParamters used to execute the command</param>
//    /// <returns>A MySqlDataAdapter  containing the resultset generated by the command</returns>
//    //public static MySqlDataAdapter  ExecuteReader(string connectionString, CommandType commandType, string commandText, params MySqlParameter[] commandParameters)
//    //{
//    //    if (connectionString == null || connectionString.Length == 0) throw new ArgumentNullException("connectionString");
...
//    /// 
//    /// e.g.:  
//    ///  MySqlDataAdapter  dr = ExecuteReader(connString, "GetOrders", 24, 36);
//    /// </remarks>
//    /// <param name="connectionString">A valid connection string for a MySqlConnection</param>
//    /// <param name="spName">The name of the stored procedure</param>
//    /// <param name="parameterValues">An array of objects to be assigned as the input values of the stored procedure</param>
//    /// <returns>A MySqlDataAdapter  containing the resultset generated by the command</returns>
//    public static MySqlDataAdapter  ExecuteReader(string connectionString, string spName, params object[] parameterValues)
//    {
//        if (connectionString == null || connectionString.Length == 0) throw new ArgumentNullException("connectionString");
//        if (spName == null || spName.Length == 0) throw new ArgumentNullException("spName");
...
//    /// <remarks>
//    /// e.g.:  
//    ///  MySqlDataAdapter  dr = ExecuteReader(conn, CommandType.StoredProcedure, "GetOrders");
//    /// </remarks>
//    /// <param name="connection">A valid MySqlConnection</param>
//    /// <param name="commandType">The CommandType (stored procedure, text, etc.)</param>
//    /// <param name="commandText">The stored procedure name or T-SQL command</param>
//    /// <returns>A MySqlDataAdapter  containing the resultset generated by the command</returns>
//    //public static MySqlDataAdapter  ExecuteReader(MySqlConnection connection, CommandType commandType, string commandText)
//    //{
//    //    // Pass through the call providing null for the set of SqlParameters
...
//    /// <remarks>
//    /// e.g.:  
//    ///  MySqlDataAdapter  dr = ExecuteReader(conn, CommandType.StoredProcedure, "GetOrders", new MySqlParameter("@prodid", 24));
//    /// </remarks>
//    /// <param name="connection">A valid MySqlConnection</param>
//    /// <param name="commandType">The CommandType (stored procedure, text, etc.)</param>
//    /// <param name="commandText">The stored procedure name or T-SQL command</param>
//    /// <param name="commandParameters">An array of SqlParamters used to execute the command</param>
//    /// <returns>A MySqlDataAdapter  containing the resultset generated by the command</returns>
//    //public static MySqlDataAdapter  ExecuteReader(MySqlConnection connection, CommandType commandType, string commandText, params MySqlParameter[] commandParameters)
//    //{
...
//    /// 
//    /// e.g.:  
//    ///  MySqlDataAdapter  dr = ExecuteReader(conn, "GetOrders", 24, 36);
//    /// </remarks>
//    /// <param name="connection">A valid MySqlConnection</param>
//    /// <param name="spName">The name of the stored procedure</param>
//    /// <param name="parameterValues">An array of objects to be assigned as the input values of the stored procedure</param>
//    /// <returns>A MySqlDataAdapter  containing the resultset generated by the command</returns>
//    //public static MySqlDataAdapter  ExecuteReader(MySqlConnection connection, string spName, params object[] parameterValues)
//    //{
//    //    if (connection == null) throw new ArgumentNullException("connection");
//    //    if (spName == null || spName.Length == 0) throw new ArgumentNullException("spName");
...
//    /// <remarks>
//    /// e.g.:  
//    ///  MySqlDataAdapter  dr = ExecuteReader(trans, CommandType.StoredProcedure, "GetOrders");
//    /// </remarks>
//    /// <param name="transaction">A valid MySqlTransaction</param>
//    /// <param name="commandType">The CommandType (stored procedure, text, etc.)</param>
//    /// <param name="commandText">The stored procedure name or T-SQL command</param>
//    /// <returns>A MySqlDataAdapter  containing the resultset generated by the command</returns>
//    public static MySqlDataAdapter  ExecuteReader(MySqlTransaction transaction, CommandType commandType, string commandText)
//    {
//        // Pass through the call providing null for the set of SqlParameters
...
//    /// <remarks>
//    /// e.g.:  
//    ///   MySqlDataAdapter  dr = ExecuteReader(trans, CommandType.StoredProcedure, "GetOrders", new MySqlParameter("@prodid", 24));
//    /// </remarks>
//    /// <param name="transaction">A valid MySqlTransaction</param>
//    /// <param name="commandType">The CommandType (stored procedure, text, etc.)</param>
//    /// <param name="commandText">The stored procedure name or T-SQL command</param>
//    /// <param name="commandParameters">An array of SqlParamters used to execute the command</param>
//    /// <returns>A MySqlDataAdapter  containing the resultset generated by the command</returns>
//    //public static MySqlDataAdapter  ExecuteReader(MySqlTransaction transaction, CommandType commandType, string commandText, params MySqlParameter[] commandParameters)
//    //{
//    //    if (transaction == null) throw new ArgumentNullException("transaction");
//    //    if (transaction != null && transaction.Connection == null) throw new ArgumentException("The transaction was rollbacked or commited, please provide an open transaction.", "transaction");
...
//    /// 
//    /// e.g.:  
//    ///  MySqlDataAdapter  dr = ExecuteReader(trans, "GetOrders", 24, 36);
//    /// </remarks>
//    /// <param name="transaction">A valid MySqlTransaction</param>
//    /// <param name="spName">The name of the stored procedure</param>
//    /// <param name="parameterValues">An array of objects to be assigned as the input values of the stored procedure</param>
//    /// <returns>A MySqlDataAdapter  containing the resultset generated by the command</returns>
//    public static MySqlDataAdapter  ExecuteReader(MySqlTransaction transaction, string spName, params object[] parameterValues)
//    {
//        if (transaction == null) throw new ArgumentNullException("transaction");
//        if (transaction != null && transaction.Connection == null) throw new ArgumentException("The transaction was rollbacked or commited, please provide an open transaction.", "transaction");
//        if (spName == null || spName.Length == 0) throw new ArgumentNullException("spName");
...
//    /// <param name="dataRow">The dataRow used to hold the stored procedure's parameter values.</param>
//    /// <returns>A MySqlDataAdapter  containing the resultset generated by the command</returns>
//    public static MySqlDataAdapter  ExecuteReaderTypedParams(String connectionString, String spName, DataRow dataRow)
//    {
//        if (connectionString == null || connectionString.Length == 0) throw new ArgumentNullException("connectionString");
//        if (spName == null || spName.Length == 0) throw new ArgumentNullException("spName");
...
//    /// <param name="dataRow">The dataRow used to hold the stored procedure's parameter values.</param>
//    /// <returns>A MySqlDataAdapter  containing the resultset generated by the command</returns>
//    public static MySqlDataAdapter  ExecuteReaderTypedParams(MySqlConnection connection, String spName, DataRow dataRow)
//    {
//        if (connection == null) throw new ArgumentNullException("connection");
//        if (spName == null || spName.Length == 0) throw new ArgumentNullException("spName");
...
//    /// <param name="dataRow">The dataRow used to hold the stored procedure's parameter values.</param>
//    /// <returns>A MySqlDataAdapter  containing the resultset generated by the command</returns>
//    public static MySqlDataAdapter  ExecuteReaderTypedParams(MySqlTransaction transaction, String spName, DataRow dataRow)
//    {
//        if (transaction == null) throw new ArgumentNullException("transaction");
//        if (transaction != null && transaction.Connection == null) throw new ArgumentException("The transaction was rollbacked or commited, please provide an open transaction.", "transaction");
//        if (spName == null || spName.Length == 0) throw new ArgumentNullException("spName");
